                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><i class="nneditlistpro btn btn-info fa fa-edit" id="ennlistpro<?php echo e($listpro->id); ?>" description="<?php echo e($listpro->description); ?>" editid="<?php echo e($listpro->id); ?>" listidmod="<?php echo e($listpro->listidmod); ?>" name="<?php echo e($listpro->listname); ?>" name_jp="<?php echo e($listpro->listname_jp); ?>" name_en="<?php echo e($listpro->listname_en); ?>" imgo="<?php echo e(asset($listpro->listimg)); ?>" img="<?php echo e($listpro->listimg); ?>" num="<?php echo e($listpro->listnumber); ?>"> Sửa</i>
