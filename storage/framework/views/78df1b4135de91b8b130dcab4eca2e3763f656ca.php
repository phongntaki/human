      ...
      <div class="col-xs-6">                        
       ...
       <div class="col-xs-6">
          <div class="form-group">
            ...
            <div class="col-xs-9">
              <p>   <?php echo e($customer->language_jp ? $customer->language_jp : '###############'); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9">
              <p>   <?php echo e($customer->language_other ? $customer->language_other : '###############'); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9">
              <p>   <?php echo e($customer->education ? $customer->education : '###############'); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9">
              <p>   <?php echo e($customer->introduce ? $customer->introduce : '###############'); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9" >
              <p>   <?php echo e($customer->desire ? $customer->desire : '###############'); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9" >
              <p>   <?php echo e($customer->cusface ? $customer->cusface : '###############'); ?>
