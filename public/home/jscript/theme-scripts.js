(function ($) {
    ...
    jQuery(window).on("scroll", function(){
        ...
        var wr = jQuery(".ot-menu-will-follow .global-nav"),
            wrfollow = jQuery(".ot-menu-will-follow .global-nav.is-now-following");
        ...
        if(wr.size() > 0 && jQuery(window).scrollTop() >= parseInt(wr.offset().top) && menuisfollowing == false){
            ...
            wr.css({"height": wr.children(".global-nav-inner").height()});
