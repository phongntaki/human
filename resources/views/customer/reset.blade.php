...
<html lang="en">
    <head>
        ...
        <!-- Font Awesome -->
        <link href="{{asset('public/bootstrap/css/font-awesome.min.css')}}" rel="stylesheet">
        <!-- NProgress -->
        <link href="{{asset('public/bootstrap/css/nprogress.css')}}" rel="stylesheet">
        <!-- Animate.css -->
        <link href="{{asset('public/bootstrap/css/animate.min.css')}}" rel="stylesheet">

        <!-- Custom Theme Style -->
        <link href="{{asset('public/bootstrap/css/custom.min.css')}}" rel="stylesheet">
    </head>
